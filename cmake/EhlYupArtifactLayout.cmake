...
function(ehl_yup_add_artifact_target)
    ...
    add_custom_target(${EHL_TARGET}
        COMMAND "${CMAKE_COMMAND}" "-DEHL_BUILD_DIR=${CMAKE_BINARY_DIR}" "-DEHL_OUTPUT_ROOT=${EHL_OUTPUT_ROOT}"
            "-DEHL_PRODUCT=${EHL_PRODUCT}" "-DEHL_SLUG=${EHL_SLUG}" "-DEHL_PROFILE=${EHL_PROFILE}"
            "-DEHL_SYSTEM_NAME=${CMAKE_SYSTEM_NAME}" "-DEHL_SYSTEM_PROCESSOR=${CMAKE_SYSTEM_PROCESSOR}"
            "-DEHL_CONFIG=$<CONFIG>" "-DEHL_EXPECT_AU=${expect_au}"
